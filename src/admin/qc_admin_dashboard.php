            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                            ...
                            <div class="widget-rounded-circle card-box">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="text-right">
                                            <?php
                                                // Código para somar o número de médicos
                        ...
                        <!-- Fim da métrica de médicos -->

                        <!-- Início da métrica de administradores -->
                        <div class="col-md-6 col-xl-4">
                            <div class="widget-rounded-circle card-box">
                                <div class="row">
                                    <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        <div class="text-right">
                                            <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo $admin_count; ?></span></h3>
                        ...
                        <!-- Fim da métrica de administradores -->
        ...
        <div class="card-box">
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover table-centered m-0">
                    ...
                    <tbody>
                        <?php
                        // SQL para obter os médicos do hospital
                        $query = "SELECT * FROM his_docs ORDER BY doc_id DESC LIMIT 10";
                        ...
                        ?>
                            <tr>
                                <td style="width: 36px;">
                                    <img src="assets/images/users/photoprofile.png<?php echo $row['doc_dpic']; ?>" alt="img" title="contact-img" class="rounded-circle avatar-sm" />
                                </td>
                                <td></td>
