	...
	include('assets/inc/config.php');
		if(isset($_POST['update_patient']))
		{
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Detalhes do paciente atualizados";
			}
			else {
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Atualizar detalhes do paciente</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label for="inputState" class="col-form-label">Paciente</label>
                                            ...
                                            <button type="submit" name="update_patient" class="ladda-button btn btn-success" data-style="expand-right">Adicionar paciente</button>
