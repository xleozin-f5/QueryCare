...
<head>
    ...
    <link rel="stylesheet" href="assets/css/styleforindexdoc.css"> <!-- Adicionando o link para o arquivo CSS personalizado -->
</head>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-between d-flex">
                    ...
                    <nav id="nav-menu-container">
                        <ul class="nav-menu">
                            <li class="menu-active"><a href="./public/login.html">Login - Page</a></li>
                            <li><a href="src/doc/index.php">Doutor</a></li>
                            <li><a href="src/admin/index.php">Admin</a></li>
                            <li><a href="src/patient/index.php">Utente</a></li>
                        </ul>
